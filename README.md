...
I am the founder of [Kreato Linux](https://linux.krea.to) and I also made multiple smaller projects including (but not limited to) [bouquet2](https://github.com/bouquet2), [Kreato's Userland (WIP)](https://github.com/kreatosuserland) and more!

# Languages I know
[![Languages I know](https://skillicons.dev/icons?i=nim,go,bash,python,md,html,css,sass,lua,swift,powershell)](https://skillicons.dev)
